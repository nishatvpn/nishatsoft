...
WHERE freeze='Active' ORDER by user_id DESC");
...
cat <<'Startupraxel' > /etc/profile.d/raxel.sh
clear
echo -e "\n SNFX NET SOLUTION Server Script"
...
echo -e " For commands and assistance, ask Raxel L. Gumboc - [DEVELOPER] for more details.\n"
echo -e " Powered by SNFX NET SOLUTION | COPYRIGHT 2018\n"
Startupraxel
chmod a+x /etc/profile.d/raxel.sh
clear
...
<hr>
<div>Developed by <b>NISHATSOFTl</b> | NISHATSERVER Net Solution</div>
